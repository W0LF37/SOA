...
| `average_overall_score` | >= 0.78 | 0.768 | **FAIL** |
...
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 3 < 9; decomposition under-produced tasks for REQ-02: expected at least 2, got 1; decomposition under-produced tasks for REQ-04: expected at least 2, got 0; missing inferred dependency at T003: expected one of ['T001', 'T002'])  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 9 < 14; decomposition under-produced tasks for REQ-01: expected at least 2, got 1; missing inferred dependency at T006: expected one of ['T002']; missing inferred dependency at T008: expected one of ['T001'])  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: req_type mismatch at T001: expected NFR, got FR; decomposition produced fewer tasks than requirements: 9 < 10; missing inferred dependency at T004: expected one of ['T002'])  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: missing inferred dependency at T003: expected one of ['T002'])  
...
Task count in expected range (7-18): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: missing inferred dependency at T003: expected one of ['T001', 'T002']; missing inferred dependency at T006: expected one of ['T004']; missing inferred dependency at T007: expected one of ['T006'])  
