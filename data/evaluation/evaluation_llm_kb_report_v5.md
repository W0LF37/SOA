...
| Metric | Value |
|---|---|
| Overall result | **PASS 20/20 samples passed** |
| Pass rate | 100.0% |
| Avg task count | 7.95 |
| Successful run rate | 100.0% |
| Direct generation rate | 15.0% |
...
|---|---|---|---|
| `fallback_rate_pct` | <= 30.0 | 85.0 | **FAIL** |
| `direct_generation_rate_pct` | >= 70.0 | 15.0 | **FAIL** |
| `average_critic_score` | >= 0.85 | 0.986 | **OK** |
| `average_overall_score` | >= 0.78 | 0.77 | **FAIL** |
...
| `has_dependency_chain` | ########## 100% |
| `critical_path_min_length` | ########## 100% |
...
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValidationError: 1 validation error for TaskList
  Value error, Task T001 has unknown dependency: T008 [type=value_error, input_value={'tasks': [{'id': 'T001',...r available doctors.'}]}, input_type=dict]
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 2 < 5; decomposition under-produced tasks for REQ-05: expected at least 2, got 0; missing inferred dependency at T002: expected one of ['T001'])  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValidationError: 1 validation error for TaskList
  Value error, Task T001 has unknown dependency: T003 [type=value_error, input_value={'tasks': [{'id': 'T001',...: [], 'complexity': 2}]}, input_type=dict]
    For further information visit https://errors.pydantic.dev/2.12/v/value_error)  
...
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValidationError: 1 validation error for TaskList
  Value error, Task T001 has unknown dependency: T007 [type=value_error, input_value={'tasks': [{'id': 'T001',...ete secure checkout.'}]}, input_type=dict]
    For further information visit https://errors.pydantic.dev/2.12/v/value_error)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: non-previous dependency T006 at T005; non-previous dependency T009 at T005; non-previous dependency T009 at T006; non-previous dependency T009 at T007)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 2 < 10; decomposition under-produced tasks for REQ-08: expected at least 2, got 0; decomposition under-produced tasks for REQ-10: expected at least 2, got 0)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: req_type mismatch at T001: expected NFR, got FR; decomposition produced fewer tasks than requirements: 2 < 10)  
...
Task count in expected range (6-16): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 2 < 10)  
...
Task count in expected range (7-18): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: non-previous dependency T008 at T001; non-previous dependency T010 at T001; non-previous dependency T008 at T002; non-previous dependency T010 at T002; non-previous dependency T008 at T005; non-previous dependency T010 at T005; non-previous dependency T008 at T006; non-previous dependency T008 at T007; non-previous dependency T010 at T007)  
...
Task count in expected range (7-18): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 2 < 10; decomposition under-produced tasks for REQ-10: expected at least 2, got 0)  
...
### [PASS] S14 -- SaaS subscription billing with dunning and revenue reporting
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValidationError: 1 validation error for TaskList
  Value error, Task T001 has unknown dependency: T009 [type=value_error, input_value={'tasks': [{'id': 'T001',...0'], 'source': 'REQ-04'}, input_type=dict]
    For further information visit https://errors.pydantic.dev/2.12/v/value_error)  
...
### [PASS] S15 -- Social networking platform with feed and moderation
...
Task count in expected range (7-18): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 4 < 10)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 2 < 5)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 4 < 5)  
...
Task count in expected range (2-8): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: req_type mismatch at T002: expected FR, got NFR; complexity out of range at T002: expected ~2, got 4; non action-oriented title at T003: 'title')  
