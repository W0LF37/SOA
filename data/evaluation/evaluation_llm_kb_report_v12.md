...
|---|---|---|---|
| `fallback_rate_pct` | <= 30.0 | 25.0 | **OK** |
| `direct_generation_rate_pct` | >= 70.0 | 75.0 | **OK** |
| `average_critic_score` | >= 0.85 | 0.986 | **OK** |
| `average_overall_score` | >= 0.78 | 0.787 | **OK** |
