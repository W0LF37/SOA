...
tasks.10.source
  String should match pattern '^(?:line \d+|block \d+(?: clause \d+)?|REQ-\d+)$' [type=string_pattern_mismatch, input_value='PROJ-09', input_type=str]
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValidationError: 1 validation error for TaskList
  Value error, Task T001 has unknown dependency: T011 [type=value_error, input_value={'tasks': [{'id': 'T001',...], 'source': 'REQ-02'}]}, input_type=dict]
...
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValidationError: 1 validation error for TaskList
  Value error, Task T001 has unknown dependency: T007 [type=value_error, input_value={'tasks': [{'id': 'T001',...entory, and pricing.'}]}, input_type=dict]
    For further information visit https://errors.pydantic.dev/2.12/v/value_error)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValidationError: 1 validation error for TaskList
  Value error, Task T001 has unknown dependency: T009 [type=value_error, input_value={'tasks': [{'id': 'T001',... [], 'source': 'REQ-09'}, input_type=dict]
    For further information visit https://errors.pydantic.dev/2.12/v/value_error)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: req_type mismatch at T001: expected NFR, got FR; decomposition produced fewer tasks than requirements: 3 < 10)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValidationError: 1 validation error for TaskList
  Value error, Task T001 has unknown dependency: T008 [type=value_error, input_value={'tasks': [{'id': 'T001',...ficates generation..'}]}, input_type=dict]
    For further information visit https://errors.pydantic.dev/2.12/v/value_error)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValidationError: 1 validation error for TaskList
  Value error, Task T002 has unknown dependency: T006 [type=value_error, input_value={'id': 'T004', 'title': '...'}], 'source': 'REQ-04'}, input_type=dict]
    For further information visit https://errors.pydantic.dev/2.12/v/value_error)  
...
Task count in expected range (2-8): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: req_type mismatch at T002: expected FR, got NFR; complexity out of range at T002: expected ~2, got 4)  
