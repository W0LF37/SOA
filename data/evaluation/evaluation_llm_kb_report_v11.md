...
|---|---|---|---|
| `fallback_rate_pct` | <= 30.0 | 35.0 | **FAIL** |
| `direct_generation_rate_pct` | >= 70.0 | 65.0 | **FAIL** |
| `average_critic_score` | >= 0.85 | 0.986 | **OK** |
| `average_overall_score` | >= 0.78 | 0.788 | **OK** |
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 4 < 14; decomposition under-produced tasks for REQ-04: expected at least 2, got 1)  
...
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: req_type mismatch at T008: expected NFR, got FR; complexity out of range at T008: expected ~4, got 2)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 7 < 10; decomposition under-produced tasks for REQ-08: expected at least 2, got 0; decomposition under-produced tasks for REQ-10: expected at least 2, got 0)  
...
Task count in expected range (6-16): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: missing dependency chain: expected at least one dependency based on requirement structure)  
