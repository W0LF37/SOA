...
|---|---|---|---|
| `fallback_rate_pct` | <= 30.0 | 30.0 | **OK** |
| `direct_generation_rate_pct` | >= 70.0 | 70.0 | **OK** |
| `average_critic_score` | >= 0.85 | 0.986 | **OK** |
| `average_overall_score` | >= 0.78 | 0.766 | **FAIL** |
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 6 < 10; decomposition under-produced tasks for REQ-08: expected at least 2, got 0; decomposition under-produced tasks for REQ-10: expected at least 2, got 0)  
