...
| Metric | Value |
|---|---|
| Overall result | **FAIL 19/20 samples passed** |
| Pass rate | 95.0% |
| Avg task count | 7.95 |
| Successful run rate | 100.0% |
| Direct generation rate | 80.0% |
...
|---|---|---|---|
| `fallback_rate_pct` | <= 30.0 | 20.0 | **OK** |
| `direct_generation_rate_pct` | >= 70.0 | 80.0 | **OK** |
| `average_critic_score` | >= 0.85 | 0.986 | **OK** |
| `average_overall_score` | >= 0.78 | 0.762 | **FAIL** |
...
| `has_dependency_chain` | #########- 90% |
| `critical_path_min_length` | #########- 90% |
...
### [FAIL] S11 -- IoT sensor monitoring dashboard with real-time alerting
...
|---|---|---|---|
| `S11` | `has_dependency_chain` | True | False |
| `S11` | `critical_path_min_length` | >= 2 | 1 |
