...
| `average_overall_score` | >= 0.78 | 0.771 | **FAIL** |
...
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: complexity out of range at T006: expected ~2, got 4; decomposition under-produced tasks for REQ-04: expected at least 2, got 1)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 7 < 14; decomposition under-produced tasks for REQ-01: expected at least 2, got 1; decomposition under-produced tasks for REQ-04: expected at least 2, got 1)  
...
tasks.6
  Input should be a valid dictionary or instance of Task [type=model_type, input_value='title', input_type=str]
...
Task count in expected range (7-18): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: req_type mismatch at T009: expected FR, got NFR; complexity out of range at T009: expected ~2, got 4)  
...
Task count in expected range (7-18): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 6 < 10; decomposition under-produced tasks for REQ-10: expected at least 2, got 0)  
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 7 < 10)  
...
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValidationError: 1 validation error for TaskList
tasks.3
  Input should be a valid dictionary or instance of Task [type=model_type, input_value=5, input_type=int]
    For further information visit https://errors.pydantic.dev/2.12/v/model_type)  
...
Task count in expected range (2-8): Yes  
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 2 < 3)  
