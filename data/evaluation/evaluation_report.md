...
**Date:** 2026-04-27 21:43:45 UTC  
**Mode:** rule_based_forced  
**Fallback rate:** 100%
...
**Tasks:** 11 (FR: 5 | NFR: 6 | Optional: 0)  
**Task Quality**  
FR:NFR ratio: 5:6  
Task count in expected range (4-20): Yes  
**Fallback:** used (Rule-based fallback was forced by pipeline configuration.)  

| Check | Result | Expected | Actual |
|---|---|---|---|
| `task_count_in_range` | **OK** | 4-20 | 11 |
| `fr_count_min` | **OK** | >= 4 | 5 |
| `nfr_count_min` | **OK** | >= 1 | 6 |
...
**Tasks:** 15 (FR: 8 | NFR: 7 | Optional: 2)  
**Task Quality**  
FR:NFR ratio: 8:7  
...
| Check | Result | Expected | Actual |
|---|---|---|---|
| `task_count_in_range` | **OK** | 8-22 | 15 |
| `fr_count_min` | **OK** | >= 6 | 8 |
| `nfr_count_min` | **OK** | >= 3 | 7 |
