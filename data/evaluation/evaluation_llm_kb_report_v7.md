...
|---|---|---|---|
| `fallback_rate_pct` | <= 30.0 | 40.0 | **FAIL** |
| `direct_generation_rate_pct` | >= 70.0 | 60.0 | **FAIL** |
| `average_critic_score` | >= 0.85 | 0.986 | **OK** |
| `average_overall_score` | >= 0.78 | 0.765 | **FAIL** |
...
Critic: approved (1.000)  
**Fallback:** used (Rule-based fallback was used after LLM planning failed: ValueError: Quality check failed: decomposition produced fewer tasks than requirements: 4 < 9)  
...
### [FAIL] S12 -- Learning Management System with quiz engine and certificates
...
|---|---|---|---|
| `S12` | `has_dependency_chain` | True | False |
| `S12` | `critical_path_min_length` | >= 2 | 1 |
